...
export default class Font1Tab extends React.Component {
    render() {
        return (
            <div className="fontsContainer Font1Tab">
                ...
                <p className="fontDesc">
                    Cies lobortis. Mauris leo ante, blandit sit amet malesuada
                    quis, ultrices eu ex. Vestibulum vestibulum ligula nunc,
                    quis faucibus neque molestie eget. Cras gravida semper
